...
Created on Fri Nov  3 12:31:42 2017
...
#    txt += "TASK_ID = '" + expset.TASK_ID + "'\n"
#    txt += "ENVIRONMENT_TYPE = '" + expset.ENVIRONMENT_TYPE + "'\n"
#    txt += "SPEED_RATE = " + str(expset.SPEED_RATE) + "\n"
#    txt += "N_REPETITIONS = " + str(expset.N_REPETITIONS) + "\n"
#    txt += "N_EPISODES = " + str(expset.N_EPISODES) + "\n"
#    txt += "N_STEPS = " + str(expset.N_STEPS) + "\n\n"
#
#    txt += "CONTINUE_PREVIOUS_EXP = " + str(expset.CONTINUE_PREVIOUS_EXP) + "\n"
#    txt += "PREVIOUS_EXP_FILE = '" + expset.PREVIOUS_EXP_FILE + "'\n"
#    txt += "FILE_MODEL = '" + expset.FILE_MODEL + "'\n"
#    txt += "N_EPISODES_MODEL = " + str(expset.N_EPISODES_MODEL) + "\n\n"
#
#    txt += "# TASK PARAMETERS \n"
